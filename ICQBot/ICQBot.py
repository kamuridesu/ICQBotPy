...
from .ext.util import Response, initLogger
...
class ICQBot:
    ...
    def setClientSession(self, session: aiohttp.ClientSession):
        ...
        if asyncio.get_event_loop().run_until_complete(verifyToken(self.session, self.token, self.endpoint)) is False:
    ...
    def info(self) -> dict[str, typing.Any]:
        ...
        """
        return asyncio.get_event_loop().run_until_complete(getBotInfo(self.session, self.token, self.endpoint))
    ...
    async def sendText(self, chat_id: str, text: str="", reply_message_id: str="", forward_chat_id: str="", forward_message_id: str="", inline_keyboard_markup: InlineKeyboardMarkup=InlineKeyboardMarkup(), formatting: Formatting=Formatting(), parse_mode: typing.Union[Markdown, HtmlMarkup]=Markdown.default(), action: typing.Union[None, Action]=None) -> SentMessage:
        ...
        return SentMessage(await sendText(self.session, self.token, self.endpoint, chat_id, text, reply_message_id, forward_chat_id, forward_message_id, inline_keyboard_markup, formatting, parse_mode), self)
    ...
    async def editMessage(self, chat_id: str, message_id: str, text: str, inline_keyboard_markup: InlineKeyboardMarkup=InlineKeyboardMarkup(), formatting: Formatting=Formatting(), parse_mode: typing.Union[Markdown, HtmlMarkup]=Markdown.default(), action: typing.Union[None, Action]=None) -> dict[str, typing.Any]:
        ...
        return await editMessage(self.session, self.token, self.endpoint, chat_id, message_id, text, inline_keyboard_markup, formatting, parse_mode)
    ...
    async def sendFile(self, chat_id: str, file: typing.Union[str, bytes, None]=None, file_id: str="", caption: str="", reply_message_id: str="", forward_chat_id: str="", forward_message_id: str="", inline_keyboard_markup: InlineKeyboardMarkup=InlineKeyboardMarkup(), formatting: Formatting=Formatting(), parse_mode: typing.Union[Markdown, HtmlMarkup]=Markdown.default()) -> dict[str, str]:
        return await sendFile(self.session, self.token, self.endpoint, chat_id, file, file_id, caption, reply_message_id, forward_chat_id, forward_message_id, inline_keyboard_markup, formatting, parse_mode)
    ...
    async def downloadFile(self, file_id: str) -> bytes:
        response: Response = await sendGetRequest(self.session, (await self.getFileInfo(file_id))['url'])
    ...
    async def sendVoice(self, chat_id: str, file: typing.Union[str, bytes, None]=None, file_id: str="", reply_message_id: str="", forward_chat_id: str="", forward_message_id: str="", inline_keyboard_markup: InlineKeyboardMarkup=InlineKeyboardMarkup()) -> dict[str, typing.Any]:
        return await sendVoice(self.session, self.token, self.endpoint, chat_id, file, file_id, reply_message_id, forward_chat_id, forward_message_id, inline_keyboard_markup)
    ...
    async def removeMembers(self, chat_id: str, members: typing.Union[list[typing.Union[str, int]], str, int]) -> bool:
        ...
        return await removeMembers(self.session, self.token, self.endpoint, chat_id, members_dict)
    ...
    async def getChatBlockedUsers(self, chat_id: str) -> list[dict]:
        return await getChatBlockedUsers(self.session, self.token, self.endpoint, chat_id)
    ...
    async def blockChatUser(self, chat_id: str, user_id: str, delete_last_messages: bool=False) -> bool:
        return await blockChatUser(self.session, self.token, self.endpoint, chat_id, user_id, delete_last_messages)
    
    async def unblockChatUser(self, chat_id: str, user_id: str) -> bool:
        return await unblockChatUser(self.session, self.token, self.endpoint, chat_id, user_id)

    async def resolvePendingUsers(self, chat_id: str, approve: bool, user_id: str="", everyone: bool=False) -> bool:
        return await resolvePendingUsers(self.session, self.token, self.endpoint, chat_id, approve, user_id, everyone)
    
    async def setGroupName(self, chat_id: str, new_name: str) -> bool:
        return await setGroupName(self.session, self.token, self.endpoint, chat_id, new_name)

    async def setGroupAbout(self, chat_id: str, about: str) -> bool:
        return await setGroupAbout(self.session, self.token, self.endpoint, chat_id, about)

    async def setGroupRules(self, chat_id: str, rules: str) -> bool:
        return await setGroupRules(self.session, self.token, self.endpoint, chat_id, rules)

    async def pinMessage(self, chat_id: str, message_id: str) -> bool:
        return await pinMessage(self.session, self.token, self.endpoint, chat_id, message_id)

    async def unpinMessage(self, chat_id: str, message_id: str) -> bool:
        return await unpinMessage(self.session, self.token, self.endpoint, chat_id, message_id)
